  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="group h-auto gap-4 py-3 text-left w-full border-none rounded-none justify-between" variant="outline">
          <div className="space-y-1">
            <h3>Change password</h3>
          </div>
          <ChevronRightIcon className="opacity-60 transition-transform group-hover:translate-x-0.5" size={16} aria-hidden="true" />
        </Button>
      </DialogTrigger>
        ...
        <AnimatePresence mode="wait">
          {step === 1 && (
            ...
            >
              <DialogHeader className="space-y-0">
                ...
                <DialogTitle className="text-2xl m-0">Check your email</DialogTitle>
                <DialogDescription>
              ...
              <Button onClick={() => onSubmit()} className="w-full dark:hover:text-white">
                Continue
              </Button>
            </motion.div>
          )}
          ...
          {step === 2 && (
            ...
            >
              <DialogHeader className="space-y-0">
                <p>vicky__tajpuriya.password_manager</p>
                <DialogTitle className="text-2xl m-0">Change password</DialogTitle>
                <DialogDescription>
              ...
              <form className="space-y-4">
                <Input className="bg-muted h-10" id="current_password" placeholder="Current password" type="password" required />
                <Input className="bg-muted h-10" id="new_password" placeholder="New password" type="password" required />
                <Input className="bg-muted h-10" id="confirm_password" placeholder="Re-type new password" type="password" required />
